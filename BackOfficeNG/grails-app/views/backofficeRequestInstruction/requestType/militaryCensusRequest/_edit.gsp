        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class=""><g:message code="mcr.property.fatherLastName.label" />  : </dt><dd id="fatherInformation.fatherLastName" class="action-editField validate-lastName i18n-mcr.property.fatherLastName maxLength-38" ><span>${rqt.fatherInformation?.fatherLastName}</span></dd>
                  ...
                  <dt class=""><g:message code="mcr.property.fatherFirstName.label" />  : </dt><dd id="fatherInformation.fatherFirstName" class="action-editField validate-firstName i18n-mcr.property.fatherFirstName maxLength-38" ><span>${rqt.fatherInformation?.fatherFirstName}</span></dd>
                  ...
                  <dt class=""><g:message code="mcr.property.fatherBirthDate.label" />  : </dt><dd id="fatherInformation.fatherBirthDate" class="action-editField validate-date i18n-mcr.property.fatherBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.fatherInformation?.fatherBirthDate}"/></span></dd>
                  ...
                  <dt class=""><g:message code="mcr.property.fatherBirthCity.label" />  : </dt><dd id="fatherInformation.fatherBirthCity" class="action-editField validate-string i18n-mcr.property.fatherBirthCity" ><span>${rqt.fatherInformation?.fatherBirthCity}</span></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="required">
                  ...
                  <dt class="required"><g:message code="mcr.property.motherLastName.label" /> * : </dt><dd id="motherInformation.motherLastName" class="action-editField validate-lastName required-true i18n-mcr.property.motherLastName maxLength-38" ><span>${rqt.motherInformation?.motherLastName}</span></dd>
                  ...
                  <dt class="required"><g:message code="mcr.property.motherFirstName.label" /> * : </dt><dd id="motherInformation.motherFirstName" class="action-editField validate-firstName required-true i18n-mcr.property.motherFirstName maxLength-38" ><span>${rqt.motherInformation?.motherFirstName}</span></dd>
                  ...
                  <dt class="required"><g:message code="mcr.property.motherBirthDate.label" /> * : </dt><dd id="motherInformation.motherBirthDate" class="action-editField validate-date required-true i18n-mcr.property.motherBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.motherInformation?.motherBirthDate}"/></span></dd>
                  ...
                  <dt class="required"><g:message code="mcr.property.motherBirthCity.label" /> * : </dt><dd id="motherInformation.motherBirthCity" class="action-editField validate-string required-true i18n-mcr.property.motherBirthCity" ><span>${rqt.motherInformation?.motherBirthCity}</span></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class="required"><g:message code="mcr.property.aliveChildren.label" /> * : </dt><dd id="familySituationInformation.aliveChildren" class="action-editField validate-positiveInteger required-true i18n-mcr.property.aliveChildren" ><span>${rqt.familySituationInformation?.aliveChildren}</span></dd>
                  ...
                  <dt class="required"><g:message code="mcr.property.childStatus.label" /> * : </dt><dd id="familySituationInformation.childStatus" class="action-editField validate-capdematEnum required-true i18n-mcr.property.childStatus javatype-fr.cg95.cvq.business.users.FamilyStatusType" ><g:capdematEnumToField var="${rqt.familySituationInformation?.childStatus}" i18nKeyPrefix="mcr.property.childStatus" /></dd>
                  ...
                  <dt class="required"><g:message code="mcr.property.childrenInCharge.label" /> * : </dt><dd id="familySituationInformation.childrenInCharge" class="action-editField validate-positiveInteger required-true i18n-mcr.property.childrenInCharge" ><span>${rqt.familySituationInformation?.childrenInCharge}</span></dd>
                  ...
                  <dt class=""><g:message code="mcr.property.otherSituation.label" />  : </dt><dd id="familySituationInformation.otherSituation" class="action-editField validate-string i18n-mcr.property.otherSituation" ><span>${rqt.familySituationInformation?.otherSituation}</span></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="required">
                  ...
                  <dt class=""><g:message code="mcr.property.childSpeciality.label" />  : </dt><dd id="professionalSituationInformation.childSpeciality" class="action-editField validate-string i18n-mcr.property.childSpeciality" ><span>${rqt.professionalSituationInformation?.childSpeciality}</span></dd>
                  ...
                  <dt class=""><g:message code="mcr.property.childProfession.label" />  : </dt><dd id="professionalSituationInformation.childProfession" class="action-editField validate-string i18n-mcr.property.childProfession" ><span>${rqt.professionalSituationInformation?.childProfession}</span></dd>
