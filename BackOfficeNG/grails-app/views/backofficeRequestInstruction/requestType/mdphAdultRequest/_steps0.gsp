  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="">
              ...
              <dt class="">${message(code:'mar.property.numeroMdph.label')} :</dt><dd id="numeroMdph" class="action-editField validate-regex i18n-mar.property.numeroMdph maxLength-13" regex="^.{0,13}$"><span>${rqt.precedentDossierMdph?.numeroMdph}</span></dd>
          
              <dt class="">${message(code:'mar.property.departementMdph.label')} :</dt><dd id="departementMdph" class="action-editField validate-capdematEnum i18n-mar.property.departementMdph javatype-fr.cg95.cvq.business.users.InseeDepartementCodeType" ><g:capdematEnumToField var="${rqt.precedentDossierMdph?.departementMdph}" i18nKeyPrefix="mar.property.departementMdph" /></dd>
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required">${message(code:'mar.property.postalCode.label')} * :</dt><dd id="postalCode" class="action-editField validate-postalCode required-true i18n-mar.property.postalCode maxLength-5" ><span>${rqt.lieuNaissanceSujet?.postalCode}</span></dd>
          
              <dt class="required">${message(code:'mar.property.city.label')} * :</dt><dd id="city" class="action-editField validate-city required-true i18n-mar.property.city maxLength-32" ><span>${rqt.lieuNaissanceSujet?.city}</span></dd>
          
              <dt class="required">${message(code:'mar.property.country.label')} * :</dt><dd id="country" class="action-editField validate-capdematEnum required-true i18n-mar.property.country javatype-fr.cg95.cvq.business.users.CountryType" ><g:capdematEnumToField var="${rqt.lieuNaissanceSujet?.country}" i18nKeyPrefix="mar.property.country" /></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required condition-situationMaritale-filled">
              ...
              <dt class="required">${message(code:'mar.property.nomNaissanceConjoint.label')} * :</dt><dd id="nomNaissanceConjoint" class="action-editField validate-lastName required-true i18n-mar.property.nomNaissanceConjoint maxLength-38" ><span>${rqt.identiteConjoint?.nomNaissanceConjoint}</span></dd>
          
              <dt class="required">${message(code:'mar.property.prenomConjoint.label')} * :</dt><dd id="prenomConjoint" class="action-editField validate-firstName required-true i18n-mar.property.prenomConjoint maxLength-38" ><span>${rqt.identiteConjoint?.prenomConjoint}</span></dd>
          
              <dt class="required">${message(code:'mar.property.dateNaissanceConjoint.label')} * :</dt><dd id="dateNaissanceConjoint" class="action-editField validate-date required-true i18n-mar.property.dateNaissanceConjoint" ><span><g:formatDate formatName="format.date" date="${rqt.identiteConjoint?.dateNaissanceConjoint}"/></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required condition-estSalarieVous-filled">
              ...
              <dt class="required">${message(code:'mar.property.salarieDepuisLe.label')} * :</dt><dd id="salarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.salarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDepuisLe}"/></span></dd>
          
              <dt class="required">${message(code:'mar.property.typeContrat.label')} * :</dt><dd id="typeContrat" class="action-editField validate-string required-true i18n-mar.property.typeContrat" ><span>${rqt.situationProfessionnelleVousSalarie?.typeContrat}</span></dd>
          
              <dt class="required">${message(code:'mar.property.salarieDateDebutContrat.label')} * :</dt><dd id="salarieDateDebutContrat" class="action-editField validate-date required-true i18n-mar.property.salarieDateDebutContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDateDebutContrat}"/></span></dd>
          
              <dt class="">${message(code:'mar.property.salarieDateFinContrat.label')} :</dt><dd id="salarieDateFinContrat" class="action-editField validate-date i18n-mar.property.salarieDateFinContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDateFinContrat}"/></span></dd>
          
              <dt class="">${message(code:'mar.property.esatDepuisLe.label')} :</dt><dd id="esatDepuisLe" class="action-editField validate-date i18n-mar.property.esatDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.esatDepuisLe}"/></span></dd>
        ...
        <dl class="required condition-estNonSalarieVous-filled">
              ...
              <dt class="required">${message(code:'mar.property.nonSalarieDepuisLe.label')} * :</dt><dd id="nonSalarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.nonSalarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousNonSalarie?.nonSalarieDepuisLe}"/></span></dd>
          
              <dt class="required">${message(code:'mar.property.regimeCotisations.label')} * :</dt><dd id="regimeCotisations" class="action-editField validate-string required-true i18n-mar.property.regimeCotisations" ><span>${rqt.situationProfessionnelleVousNonSalarie?.regimeCotisations}</span></dd>
        ...
        <dl class="required condition-estRetraiteVous-filled">
              ...
              <dt class="required">${message(code:'mar.property.retraiteDepuisLe.label')} * :</dt><dd id="retraiteDepuisLe" class="action-editField validate-date required-true i18n-mar.property.retraiteDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousRetraite?.retraiteDepuisLe}"/></span></dd>
        ...
        <dl class="required condition-estAutreVous-filled">
              ...
              <dt class="required">${message(code:'mar.property.autreDepuisLe.label')} * :</dt><dd id="autreDepuisLe" class="action-editField validate-date required-true i18n-mar.property.autreDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousAutre?.autreDepuisLe}"/></span></dd>
          
              <dt class="required">${message(code:'mar.property.precisionAutreSituationProfessionnelle.label')} * :</dt><dd id="precisionAutreSituationProfessionnelle" class="action-editField validate-string required-true i18n-mar.property.precisionAutreSituationProfessionnelle" ><span>${rqt.situationProfessionnelleVousAutre?.precisionAutreSituationProfessionnelle}</span></dd>
    ...
    <div class="yui-u">
        ...
        <dl class="required condition-estSalarieConjoint-filled">
              ...
              <dt class="required">${message(code:'mar.property.salarieDepuisLe.label')} * :</dt><dd id="salarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.salarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.salarieDepuisLe}"/></span></dd>
          
              <dt class="required">${message(code:'mar.property.typeContrat.label')} * :</dt><dd id="typeContrat" class="action-editField validate-string required-true i18n-mar.property.typeContrat" ><span>${rqt.situationProfessionnelleConjointSalarie?.typeContrat}</span></dd>
              ...
              <dt class="">${message(code:'mar.property.salarieDateFinContrat.label')} :</dt><dd id="salarieDateFinContrat" class="action-editField validate-date i18n-mar.property.salarieDateFinContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.salarieDateFinContrat}"/></span></dd>
          
              <dt class="">${message(code:'mar.property.esatDepuisLe.label')} :</dt><dd id="esatDepuisLe" class="action-editField validate-date i18n-mar.property.esatDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.esatDepuisLe}"/></span></dd>
        ...
        <dl class="required condition-estStagiaireConjoint-filled">
              ...
              <dt class="required">${message(code:'mar.property.stagiaireDepuisLe.label')} * :</dt><dd id="stagiaireDepuisLe" class="action-editField validate-date required-true i18n-mar.property.stagiaireDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointStagiaire?.stagiaireDepuisLe}"/></span></dd>
              ...
              <dt class="required">${message(code:'mar.property.nomEmployeurStage.label')} * :</dt><dd id="nomEmployeurStage" class="action-editField validate-lastName required-true i18n-mar.property.nomEmployeurStage maxLength-38" ><span>${rqt.situationProfessionnelleConjointStagiaire?.nomEmployeurStage}</span></dd>
              ...
              <dt class="required">${message(code:'mar.property.telephoneEmployeurStage.label')} * :</dt><dd id="telephoneEmployeurStage" class="action-editField validate-phone required-true i18n-mar.property.telephoneEmployeurStage maxLength-10" ><span>${rqt.situationProfessionnelleConjointStagiaire?.telephoneEmployeurStage}</span></dd>
        ...
        <dl class="required condition-estNonSalarieConjoint-filled">
              ...
              <dt class="required">${message(code:'mar.property.nonSalarieDepuisLe.label')} * :</dt><dd id="nonSalarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.nonSalarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointNonSalarie?.nonSalarieDepuisLe}"/></span></dd>
          
              <dt class="required">${message(code:'mar.property.regimeCotisations.label')} * :</dt><dd id="regimeCotisations" class="action-editField validate-string required-true i18n-mar.property.regimeCotisations" ><span>${rqt.situationProfessionnelleConjointNonSalarie?.regimeCotisations}</span></dd>
        ...
        <dl class="required condition-estRetraiteConjoint-filled">
              ...
              <dt class="required">${message(code:'mar.property.retraiteDepuisLe.label')} * :</dt><dd id="retraiteDepuisLe" class="action-editField validate-date required-true i18n-mar.property.retraiteDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointRetraite?.retraiteDepuisLe}"/></span></dd>
        ...
        <dl class="required condition-estAutreConjoint-filled">
              ...
              <dt class="required">${message(code:'mar.property.autreDepuisLe.label')} * :</dt><dd id="autreDepuisLe" class="action-editField validate-date required-true i18n-mar.property.autreDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointAutre?.autreDepuisLe}"/></span></dd>
