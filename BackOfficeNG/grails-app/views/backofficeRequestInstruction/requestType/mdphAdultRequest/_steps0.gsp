...
<div id="page0">
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl>
          <dt class=""><g:message code="mar.property.faxSujet.label" />  : </dt><dd id="faxSujet" class="action-editField validate-phone i18n-mar.property.faxSujet maxLength-10" ><span>${rqt?.faxSujet}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.nationalite.label" /> * : </dt><dd id="nationalite" class="action-editField validate-capdematEnum required-true i18n-mar.property.nationalite javatype-fr.cg95.cvq.business.request.social.NationaliteAvecSuisseType" ><g:capdematEnumToField var="${rqt?.nationalite}" i18nKeyPrefix="mar.property.nationalite" /></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.dateNaissanceSujet.label" /> * : </dt><dd id="dateNaissanceSujet" class="action-editField validate-date required-true i18n-mar.property.dateNaissanceSujet" ><span><g:formatDate formatName="format.date" date="${rqt?.dateNaissanceSujet}"/></span></dd>
        </dl>
        
      
        
        <dl>
          <dt class=""><g:message code="mar.property.dateArriveeFrance.label" />  : </dt><dd id="dateArriveeFrance" class="action-editField validate-date i18n-mar.property.dateArriveeFrance" ><span><g:formatDate formatName="format.date" date="${rqt?.dateArriveeFrance}"/></span></dd>
        </dl>
        ...
        <dl class="">
              ...
              <dt class=""><g:message code="mar.property.numeroMdph.label" />  : </dt><dd id="precedentDossierMdph.numeroMdph" class="action-editField validate-regex i18n-mar.property.numeroMdph maxLength-13" regex="^.{0,13}$"><span>${rqt.precedentDossierMdph?.numeroMdph}</span></dd>
          
              <dt class=""><g:message code="mar.property.departementMdph.label" />  : </dt><dd id="precedentDossierMdph.departementMdph" class="action-editField validate-capdematEnum i18n-mar.property.departementMdph javatype-fr.cg95.cvq.business.users.InseeDepartementCodeType" ><g:capdematEnumToField var="${rqt.precedentDossierMdph?.departementMdph}" i18nKeyPrefix="mar.property.departementMdph" /></dd>
        ...
        <dl>
          <dt class=""><g:message code="mar.property.precisionSiDomicileAupresOrganisme.label" />  : </dt><dd id="precisionSiDomicileAupresOrganisme" class="action-editField validate-string i18n-mar.property.precisionSiDomicileAupresOrganisme" ><span>${rqt?.precisionSiDomicileAupresOrganisme}</span></dd>
        </dl>
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required"><g:message code="mar.property.postalCode.label" /> * : </dt><dd id="lieuNaissanceSujet.postalCode" class="action-editField validate-postalCode required-true i18n-mar.property.postalCode maxLength-5" ><span>${rqt.lieuNaissanceSujet?.postalCode}</span></dd>
          
              <dt class="required"><g:message code="mar.property.city.label" /> * : </dt><dd id="lieuNaissanceSujet.city" class="action-editField validate-city required-true i18n-mar.property.city maxLength-32" ><span>${rqt.lieuNaissanceSujet?.city}</span></dd>
          
              <dt class="required"><g:message code="mar.property.country.label" /> * : </dt><dd id="lieuNaissanceSujet.country" class="action-editField validate-capdematEnum required-true i18n-mar.property.country javatype-fr.cg95.cvq.business.users.CountryType" ><g:capdematEnumToField var="${rqt.lieuNaissanceSujet?.country}" i18nKeyPrefix="mar.property.country" /></dd>
        ...
        <dl>
          <dt class="required"><g:message code="mar.property.numeroSecuriteSocialeSujet.label" /> * : </dt><dd id="numeroSecuriteSocialeSujet" class="action-editField validate-regex required-true i18n-mar.property.numeroSecuriteSocialeSujet maxLength-13" regex="[0-9]{13}"><span>${rqt?.numeroSecuriteSocialeSujet}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.nomOrganismeSecuriteSociale.label" /> * : </dt><dd id="nomOrganismeSecuriteSociale" class="action-editField validate-regex required-true i18n-mar.property.nomOrganismeSecuriteSociale maxLength-50" regex="^.{0,50}$"><span>${rqt?.nomOrganismeSecuriteSociale}</span></dd>
        </dl>
...
<div id="page1">
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl>
          <dt class="required condition-representantLegal-filled"><g:message code="mar.property.telResponsableLegal.label" /> * : </dt><dd id="telResponsableLegal" class="action-editField validate-phone required-true i18n-mar.property.telResponsableLegal maxLength-10" ><span>${rqt?.telResponsableLegal}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="condition-representantLegal-filled"><g:message code="mar.property.faxResponsableLegal.label" />  : </dt><dd id="faxResponsableLegal" class="action-editField validate-phone i18n-mar.property.faxResponsableLegal maxLength-10" ><span>${rqt?.faxResponsableLegal}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="condition-representantLegal-filled"><g:message code="mar.property.emailResponsableLegal.label" />  : </dt><dd id="emailResponsableLegal" class="action-editField validate-email i18n-mar.property.emailResponsableLegal" ><span>${rqt?.emailResponsableLegal}</span></dd>
        </dl>
...
<div id="page2">
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl>
          <dt class="required"><g:message code="mar.property.nomAllocataire.label" /> * : </dt><dd id="nomAllocataire" class="action-editField validate-lastName required-true i18n-mar.property.nomAllocataire maxLength-38" ><span>${rqt?.nomAllocataire}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.prenomAllocataire.label" /> * : </dt><dd id="prenomAllocataire" class="action-editField validate-firstName required-true i18n-mar.property.prenomAllocataire maxLength-38" ><span>${rqt?.prenomAllocataire}</span></dd>
        </dl>
...
<div id="page3">
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl>
          <dt class="required condition-situationMaritale-trigger"><g:message code="mar.property.situationMaritale.label" /> * : </dt><dd id="situationMaritale" class="action-editField validate-capdematEnum required-true i18n-mar.property.situationMaritale javatype-fr.cg95.cvq.business.request.social.SituationFamilialeType" ><g:capdematEnumToField var="${rqt?.situationMaritale}" i18nKeyPrefix="mar.property.situationMaritale" /></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.dateSituationFamiliale.label" /> * : </dt><dd id="dateSituationFamiliale" class="action-editField validate-date required-true i18n-mar.property.dateSituationFamiliale" ><span><g:formatDate formatName="format.date" date="${rqt?.dateSituationFamiliale}"/></span></dd>
        </dl>
        
      
        
        <dl>
          <dt class="required"><g:message code="mar.property.nombreEnfantsACharge.label" /> * : </dt><dd id="nombreEnfantsACharge" class="action-editField validate-regex required-true i18n-mar.property.nombreEnfantsACharge maxLength-2" regex="[0-9]{1,2}$"><span>${rqt?.nombreEnfantsACharge}</span></dd>
        </dl>
    ...
    <div class="yui-u">
        ...
        <dl class="required condition-situationMaritale-filled">
              ...
              <dt class="required"><g:message code="mar.property.nomNaissanceConjoint.label" /> * : </dt><dd id="identiteConjoint.nomNaissanceConjoint" class="action-editField validate-lastName required-true i18n-mar.property.nomNaissanceConjoint maxLength-38" ><span>${rqt.identiteConjoint?.nomNaissanceConjoint}</span></dd>
          
              <dt class="required"><g:message code="mar.property.prenomConjoint.label" /> * : </dt><dd id="identiteConjoint.prenomConjoint" class="action-editField validate-firstName required-true i18n-mar.property.prenomConjoint maxLength-38" ><span>${rqt.identiteConjoint?.prenomConjoint}</span></dd>
          
              <dt class="required"><g:message code="mar.property.dateNaissanceConjoint.label" /> * : </dt><dd id="identiteConjoint.dateNaissanceConjoint" class="action-editField validate-date required-true i18n-mar.property.dateNaissanceConjoint" ><span><g:formatDate formatName="format.date" date="${rqt.identiteConjoint?.dateNaissanceConjoint}"/></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required condition-estSalarieVous-filled">
              ...
              <dt class="required"><g:message code="mar.property.salarieDepuisLe.label" /> * : </dt><dd id="situationProfessionnelleVousSalarie.salarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.salarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDepuisLe}"/></span></dd>
          
              <dt class="required"><g:message code="mar.property.typeContrat.label" /> * : </dt><dd id="situationProfessionnelleVousSalarie.typeContrat" class="action-editField validate-string required-true i18n-mar.property.typeContrat" ><span>${rqt.situationProfessionnelleVousSalarie?.typeContrat}</span></dd>
          
              <dt class="required"><g:message code="mar.property.salarieDateDebutContrat.label" /> * : </dt><dd id="situationProfessionnelleVousSalarie.salarieDateDebutContrat" class="action-editField validate-date required-true i18n-mar.property.salarieDateDebutContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDateDebutContrat}"/></span></dd>
          
              <dt class=""><g:message code="mar.property.salarieDateFinContrat.label" />  : </dt><dd id="situationProfessionnelleVousSalarie.salarieDateFinContrat" class="action-editField validate-date i18n-mar.property.salarieDateFinContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.salarieDateFinContrat}"/></span></dd>
          
              <dt class=""><g:message code="mar.property.esatDepuisLe.label" />  : </dt><dd id="situationProfessionnelleVousSalarie.esatDepuisLe" class="action-editField validate-date i18n-mar.property.esatDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousSalarie?.esatDepuisLe}"/></span></dd>
        ...
        <dl class="required condition-estNonSalarieVous-filled">
              ...
              <dt class="required"><g:message code="mar.property.nonSalarieDepuisLe.label" /> * : </dt><dd id="situationProfessionnelleVousNonSalarie.nonSalarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.nonSalarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleVousNonSalarie?.nonSalarieDepuisLe}"/></span></dd>
          
              <dt class="required"><g:message code="mar.property.regimeCotisations.label" /> * : </dt><dd id="situationProfessionnelleVousNonSalarie.regimeCotisations" class="action-editField validate-string required-true i18n-mar.property.regimeCotisations" ><span>${rqt.situationProfessionnelleVousNonSalarie?.regimeCotisations}</span></dd>
    ...
    <div class="yui-u">
        ...
        <dl class="required condition-estSalarieConjoint-filled">
              ...
              <dt class="required"><g:message code="mar.property.salarieDepuisLe.label" /> * : </dt><dd id="situationProfessionnelleConjointSalarie.salarieDepuisLe" class="action-editField validate-date required-true i18n-mar.property.salarieDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.salarieDepuisLe}"/></span></dd>
          
              <dt class="required"><g:message code="mar.property.typeContrat.label" /> * : </dt><dd id="situationProfessionnelleConjointSalarie.typeContrat" class="action-editField validate-string required-true i18n-mar.property.typeContrat" ><span>${rqt.situationProfessionnelleConjointSalarie?.typeContrat}</span></dd>
          
              <dt class="required"><g:message code="mar.property.salarieDateDebutContrat.label" /> * : </dt><dd id="situationProfessionnelleConjointSalarie.salarieDateDebutContrat" class="action-editField validate-date required-true i18n-mar.property.salarieDateDebutContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.salarieDateDebutContrat}"/></span></dd>
          
              <dt class=""><g:message code="mar.property.salarieDateFinContrat.label" />  : </dt><dd id="situationProfessionnelleConjointSalarie.salarieDateFinContrat" class="action-editField validate-date i18n-mar.property.salarieDateFinContrat" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.salarieDateFinContrat}"/></span></dd>
          
              <dt class=""><g:message code="mar.property.esatDepuisLe.label" />  : </dt><dd id="situationProfessionnelleConjointSalarie.esatDepuisLe" class="action-editField validate-date i18n-mar.property.esatDepuisLe" ><span><g:formatDate formatName="format.date" date="${rqt.situationProfessionnelleConjointSalarie?.esatDepuisLe}"/></span></dd>
