        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dd><span>${subjectIsChild && !subject?.born ? message(code:'request.subject.childNoBorn', args:[subject?.getFullName()]) : subject?.fullName}</span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectTitle.label" /> * : </dt><dd id="rsrSubject.subjectTitle" class="action-editField validate-capdematEnum required-true i18n-rsr.property.subjectTitle javatype-fr.cg95.cvq.business.users.TitleType" ><g:capdematEnumToField var="${rqt.rsrSubject?.subjectTitle}" i18nKeyPrefix="rsr.property.subjectTitle" /></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectBirthDate.label" /> * : </dt><dd id="rsrSubject.subjectBirthDate" class="action-editField validate-date required-true i18n-rsr.property.subjectBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.rsrSubject?.subjectBirthDate}"/></span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectResideWith.label" /> * : </dt><dd id="rsrSubject.subjectResideWith" class="action-editField validate-capdematEnum required-true i18n-rsr.property.subjectResideWith javatype-fr.cg95.cvq.business.request.social.RsrSubjectResideWithType" ><g:capdematEnumToField var="${rqt.rsrSubject?.subjectResideWith}" i18nKeyPrefix="rsr.property.subjectResideWith" /></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectIsTaxable.label" /> * : </dt><dd id="rsrSubject.subjectIsTaxable" class="action-editField validate-boolean required-true i18n-rsr.property.subjectIsTaxable" ><span class="value-${rqt.rsrSubject?.subjectIsTaxable}"><g:message code="message.${rqt.rsrSubject?.subjectIsTaxable ? 'yes' : 'no'}" /></span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectIsAPABeneficiary.label" /> * : </dt><dd id="rsrSubject.subjectIsAPABeneficiary" class="action-editField validate-boolean required-true i18n-rsr.property.subjectIsAPABeneficiary" ><span class="value-${rqt.rsrSubject?.subjectIsAPABeneficiary}"><g:message code="message.${rqt.rsrSubject?.subjectIsAPABeneficiary ? 'yes' : 'no'}" /></span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.subjectIsDisabledPerson.label" /> * : </dt><dd id="rsrSubject.subjectIsDisabledPerson" class="action-editField validate-boolean required-true i18n-rsr.property.subjectIsDisabledPerson" ><span class="value-${rqt.rsrSubject?.subjectIsDisabledPerson}"><g:message code="message.${rqt.rsrSubject?.subjectIsDisabledPerson ? 'yes' : 'no'}" /></span></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="required condition-isCoupleRequest-filled">
                  ...
                  <dt class="required"><g:message code="rsr.property.spouseLastName.label" /> * : </dt><dd id="spouse.spouseLastName" class="action-editField validate-lastName required-true i18n-rsr.property.spouseLastName maxLength-38" ><span>${rqt.spouse?.spouseLastName}</span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.spouseFirstName.label" /> * : </dt><dd id="spouse.spouseFirstName" class="action-editField validate-firstName required-true i18n-rsr.property.spouseFirstName maxLength-38" ><span>${rqt.spouse?.spouseFirstName}</span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.spouseTitle.label" /> * : </dt><dd id="spouse.spouseTitle" class="action-editField validate-capdematEnum required-true i18n-rsr.property.spouseTitle javatype-fr.cg95.cvq.business.users.TitleType" ><g:capdematEnumToField var="${rqt.spouse?.spouseTitle}" i18nKeyPrefix="rsr.property.spouseTitle" /></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.spouseBirthDate.label" /> * : </dt><dd id="spouse.spouseBirthDate" class="action-editField validate-date required-true i18n-rsr.property.spouseBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.spouse?.spouseBirthDate}"/></span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.spouseIsDisabledPerson.label" /> * : </dt><dd id="spouse.spouseIsDisabledPerson" class="action-editField validate-boolean required-true i18n-rsr.property.spouseIsDisabledPerson" ><span class="value-${rqt.spouse?.spouseIsDisabledPerson}"><g:message code="message.${rqt.spouse?.spouseIsDisabledPerson ? 'yes' : 'no'}" /></span></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required condition-isOtherContact-filled">
                  ...
                  <dt class="required"><g:message code="rsr.property.contactLastName.label" /> * : </dt><dd id="firstContact.contactLastName" class="action-editField validate-lastName required-true i18n-rsr.property.contactLastName maxLength-38" ><span>${rqt.firstContact?.contactLastName}</span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.contactFirstName.label" /> * : </dt><dd id="firstContact.contactFirstName" class="action-editField validate-firstName required-true i18n-rsr.property.contactFirstName maxLength-38" ><span>${rqt.firstContact?.contactFirstName}</span></dd>
                  ...
                  <dt class="required"><g:message code="rsr.property.contactPhone.label" /> * : </dt><dd id="firstContact.contactPhone" class="action-editField validate-phone required-true i18n-rsr.property.contactPhone maxLength-10" ><span>${rqt.firstContact?.contactPhone}</span></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="required condition-isOtherContact-filled">
                  ...
                  <dt class=""><g:message code="rsr.property.secondContactLastName.label" />  : </dt><dd id="secondContact.secondContactLastName" class="action-editField validate-lastName i18n-rsr.property.secondContactLastName maxLength-38" ><span>${rqt.secondContact?.secondContactLastName}</span></dd>
                  ...
                  <dt class=""><g:message code="rsr.property.secondContactFirstName.label" />  : </dt><dd id="secondContact.secondContactFirstName" class="action-editField validate-firstName i18n-rsr.property.secondContactFirstName maxLength-38" ><span>${rqt.secondContact?.secondContactFirstName}</span></dd>
                  ...
                  <dt class=""><g:message code="rsr.property.secondContactPhone.label" />  : </dt><dd id="secondContact.secondContactPhone" class="action-editField validate-phone i18n-rsr.property.secondContactPhone maxLength-10" ><span>${rqt.secondContact?.secondContactPhone}</span></dd>
              ...
              <dl class="required">
                  ...
                  <dt class=""><g:message code="rsr.property.trusteeLastName.label" />  : </dt><dd id="trustee.trusteeLastName" class="action-editField validate-lastName i18n-rsr.property.trusteeLastName maxLength-38" ><span>${rqt.trustee?.trusteeLastName}</span></dd>
                  ...
                  <dt class=""><g:message code="rsr.property.trusteeFirstName.label" />  : </dt><dd id="trustee.trusteeFirstName" class="action-editField validate-firstName i18n-rsr.property.trusteeFirstName maxLength-38" ><span>${rqt.trustee?.trusteeFirstName}</span></dd>
                  ...
                  <dt class=""><g:message code="rsr.property.trusteePhone.label" />  : </dt><dd id="trustee.trusteePhone" class="action-editField validate-phone i18n-rsr.property.trusteePhone maxLength-10" ><span>${rqt.trustee?.trusteePhone}</span></dd>
