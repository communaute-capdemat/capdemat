          ...
          <div class="yui-u first">
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'foodDiet', 'lrEntries': lrTypes.foodDiet?.entries, 
                             ...
                             'wrapper':rqt, 'isMultiple':lrTypes.foodDiet?.entriesSupportMultiple, 'depth':0]" />
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'canteenAttendingDays', 'lrEntries': lrTypes.canteenAttendingDays?.entries, 
                             ...
                             'wrapper':rqt, 'isMultiple':lrTypes.canteenAttendingDays?.entriesSupportMultiple, 'depth':0]" />
