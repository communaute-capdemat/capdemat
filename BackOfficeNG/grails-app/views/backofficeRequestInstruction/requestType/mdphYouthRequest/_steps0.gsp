  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="">
              ...
              <dt class="">${message(code:'myr.property.numeroMdph.label')} :</dt><dd id="precedentDossierMdph.numeroMdph" class="action-editField validate-regex i18n-myr.property.numeroMdph maxLength-13" regex="^.{0,13}$"><span>${rqt.precedentDossierMdph?.numeroMdph}</span></dd>
          
              <dt class="">${message(code:'myr.property.departementMdph.label')} :</dt><dd id="precedentDossierMdph.departementMdph" class="action-editField validate-capdematEnum i18n-myr.property.departementMdph javatype-fr.cg95.cvq.business.users.InseeDepartementCodeType" ><g:capdematEnumToField var="${rqt.precedentDossierMdph?.departementMdph}" i18nKeyPrefix="myr.property.departementMdph" /></dd>
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required">${message(code:'myr.property.postalCode.label')} * :</dt><dd id="lieuNaissanceSujet.postalCode" class="action-editField validate-postalCode required-true i18n-myr.property.postalCode maxLength-5" ><span>${rqt.lieuNaissanceSujet?.postalCode}</span></dd>
          
              <dt class="required">${message(code:'myr.property.city.label')} * :</dt><dd id="lieuNaissanceSujet.city" class="action-editField validate-city required-true i18n-myr.property.city maxLength-32" ><span>${rqt.lieuNaissanceSujet?.city}</span></dd>
          
              <dt class="required">${message(code:'myr.property.country.label')} * :</dt><dd id="lieuNaissanceSujet.country" class="action-editField validate-capdematEnum required-true i18n-myr.property.country javatype-fr.cg95.cvq.business.users.CountryType" ><g:capdematEnumToField var="${rqt.lieuNaissanceSujet?.country}" i18nKeyPrefix="myr.property.country" /></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required condition-situationMaritale-filled">
              ...
              <dt class="required">${message(code:'myr.property.nomNaissanceConjoint.label')} * :</dt><dd id="identiteConjoint.nomNaissanceConjoint" class="action-editField validate-lastName required-true i18n-myr.property.nomNaissanceConjoint maxLength-38" ><span>${rqt.identiteConjoint?.nomNaissanceConjoint}</span></dd>
          
              <dt class="required">${message(code:'myr.property.prenomConjoint.label')} * :</dt><dd id="identiteConjoint.prenomConjoint" class="action-editField validate-firstName required-true i18n-myr.property.prenomConjoint maxLength-38" ><span>${rqt.identiteConjoint?.prenomConjoint}</span></dd>
          
              <dt class="required">${message(code:'myr.property.dateNaissanceConjoint.label')} * :</dt><dd id="identiteConjoint.dateNaissanceConjoint" class="action-editField validate-date required-true i18n-myr.property.dateNaissanceConjoint" ><span><g:formatDate formatName="format.date" date="${rqt.identiteConjoint?.dateNaissanceConjoint}"/></span></dd>
