        ...
        <div class="yui-g">
          ...
          <div class="yui-u">
              ...
              <dl class="required">
                  ...
                  <dt class=""><g:message code="srr.property.currentSchoolName.label" />  : </dt><dd id="currentSchool.currentSchoolName" class="action-editField validate-string i18n-srr.property.currentSchoolName" ><span>${rqt.currentSchool?.currentSchoolName}</span></dd>
                  ...
                  <dt class=""><g:message code="srr.property.currentSchoolAddress.label" />  : </dt><dd id="currentSchool.currentSchoolAddress" class="action-editField validate-string i18n-srr.property.currentSchoolAddress" ><span>${rqt.currentSchool?.currentSchoolAddress}</span></dd>
