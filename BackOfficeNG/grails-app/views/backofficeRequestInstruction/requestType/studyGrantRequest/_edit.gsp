        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dd><span>${subjectIsChild && !subject?.born ? message(code:'request.subject.childNoBorn', args:[subject?.getFullName()]) : subject?.fullName}</span></dd>
                  ...
                  <dt class="required">${message(code:'sgr.property.subjectBirthDate.label')} * :</dt><dd id="subjectBirthDate" class="action-editField validate-date required-true i18n-sgr.property.subjectBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.subjectInformations?.subjectBirthDate}"/></span></dd>
          ...
          <div class="yui-u first">
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'taxHouseholdCity', 'lrEntries': lrTypes.taxHouseholdCity?.entries, 
                             'wrapper':rqt, 'isMultiple':lrTypes.taxHouseholdCity?.isMultiple(), 'depth':0]" />
          </dd>
              </dl>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'currentSchoolName', 'lrEntries': lrTypes.currentSchoolName?.entries, 
                             'wrapper':rqt.currentSchool, 'isMultiple':lrTypes.currentSchoolName?.isMultiple(), 'depth':0]" />
          </dd>
                
                  <dt class="required condition-isCurrentSchoolNameOther-filled">${message(code:'sgr.property.currentSchoolNamePrecision.label')} * :</dt><dd id="currentSchoolNamePrecision" class="action-editField validate-string required-true i18n-sgr.property.currentSchoolNamePrecision" ><span>${rqt.currentSchool?.currentSchoolNamePrecision}</span></dd>
                
                  <dt class="required condition-isCurrentSchoolNameOther-filled">${message(code:'sgr.property.currentSchoolAddress.label')} * :</dt><dd id="currentSchoolAddress" class="action-editField validate-address required-true i18n-sgr.property.currentSchoolAddress" ><div><p class="additionalDeliveryInformation">${rqt.currentSchool?.currentSchoolAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt.currentSchool?.currentSchoolAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt.currentSchool?.currentSchoolAddress?.streetNumber}</span> <span class="streetName">${rqt.currentSchool?.currentSchoolAddress?.streetName}</span><g:if test="${!!rqt.currentSchool?.currentSchoolAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt.currentSchool?.currentSchoolAddress?.streetMatriculation}</span></g:if><g:if test="${!!rqt.currentSchool?.currentSchoolAddress?.streetRivoliCode}"><br /><em><g:message code="address.property.streetRivoliCode" /></em><span class="streetRivoliCode">${rqt.currentSchool?.currentSchoolAddress?.streetRivoliCode}</span></g:if><p class="placeNameOrService">${rqt.currentSchool?.currentSchoolAddress?.placeNameOrService}</p><span class="postalCode">${rqt.currentSchool?.currentSchoolAddress?.postalCode}</span> <span class="city">${rqt.currentSchool?.currentSchoolAddress?.city}</span><p class="countryName">${rqt.currentSchool?.currentSchoolAddress?.countryName}</p><g:if test="${!!rqt.currentSchool?.currentSchoolAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt.currentSchool?.currentSchoolAddress?.cityInseeCode}</span></g:if></div></dd>
              ...
              <dl class="required">
                  ...
                  <dt class="required">${message(code:'sgr.property.alevelsDate.label')} * :</dt><dd id="alevelsDate" class="action-editField validate-regex required-true i18n-sgr.property.alevelsDate maxLength-4" regex="^\d{2,4}$"><span>${rqt.alevelsInformations?.alevelsDate}</span></dd>
                
                  <dt class="required">${message(code:'sgr.property.alevels.label')} * :</dt><dd id="alevels" class="action-editField validate-capdematEnum required-true i18n-sgr.property.alevels javatype-fr.cg95.cvq.business.request.school.ALevelsType" ><g:capdematEnumToField var="${rqt.alevelsInformations?.alevels}" i18nKeyPrefix="sgr.property.alevels" /></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="">
                  ...
                  <dt class="required condition-isInOtherStudies-filled">${message(code:'sgr.property.otherStudiesLabel.label')} * :</dt><dd id="otherStudiesLabel" class="action-editField validate-string required-true i18n-sgr.property.otherStudiesLabel" ><span>${rqt.currentStudiesInformations?.otherStudiesLabel}</span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-filled">${message(code:'sgr.property.abroadInternshipSchoolName.label')} * :</dt><dd id="abroadInternshipSchoolName" class="action-editField validate-string required-true i18n-sgr.property.abroadInternshipSchoolName" ><span>${rqt.currentStudiesInformations?.abroadInternshipSchoolName}</span></dd>
