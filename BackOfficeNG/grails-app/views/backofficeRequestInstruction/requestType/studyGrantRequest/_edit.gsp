        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dd><span>${subjectIsChild && !subject?.born ? message(code:'request.subject.childNoBorn', args:[subject?.getFullName()]) : subject?.fullName}</span></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.subjectBirthDate.label" /> * : </dt><dd id="subjectInformations.subjectBirthDate" class="action-editField validate-date required-true i18n-sgr.property.subjectBirthDate" ><span><g:formatDate formatName="format.date" date="${rqt.subjectInformations?.subjectBirthDate}"/></span></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.subjectFirstRequest.label" /> * : </dt><dd id="subjectInformations.subjectFirstRequest" class="action-editField validate-boolean required-true i18n-sgr.property.subjectFirstRequest" ><span class="value-${rqt.subjectInformations?.subjectFirstRequest}"><g:message code="message.${rqt.subjectInformations?.subjectFirstRequest ? 'yes' : 'no'}" /></span></dd>
          ...
          <div class="yui-u first">
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'taxHouseholdCity', 'lrEntries': lrTypes.taxHouseholdCity?.entries, 
                             ...
                             'wrapper':rqt, 'isMultiple':lrTypes.taxHouseholdCity?.entriesSupportMultiple, 'depth':0]" />
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="">
                  ...
                  <dt class="required condition-isCurrentSchoolNameOther-trigger"><g:message code="sgr.property.currentSchoolName.label" /> * : </dt><dd id="currentSchool.currentSchoolName" class="action-editField validate-localReferentialData required-true i18n-sgr.property.currentSchoolName data-localReferentialData" >
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
                     model="['javaName':'currentSchoolName', 'lrEntries': lrTypes.currentSchoolName?.entries, 
                             ...
                             'wrapper':rqt.currentSchool, 'isMultiple':lrTypes.currentSchoolName?.entriesSupportMultiple, 'depth':0]" />
                  ...
                  <dt class="required condition-isCurrentSchoolNameOther-filled"><g:message code="sgr.property.currentSchoolNamePrecision.label" /> * : </dt><dd id="currentSchool.currentSchoolNamePrecision" class="action-editField validate-string required-true i18n-sgr.property.currentSchoolNamePrecision" ><span>${rqt.currentSchool?.currentSchoolNamePrecision}</span></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.currentSchoolPostalCode.label" /> * : </dt><dd id="currentSchool.currentSchoolPostalCode" class="action-editField validate-postalCode required-true i18n-sgr.property.currentSchoolPostalCode maxLength-5" ><span>${rqt.currentSchool?.currentSchoolPostalCode}</span></dd>
                
                  <dt class="required"><g:message code="sgr.property.currentSchoolCity.label" /> * : </dt><dd id="currentSchool.currentSchoolCity" class="action-editField validate-city required-true i18n-sgr.property.currentSchoolCity maxLength-32" ><span>${rqt.currentSchool?.currentSchoolCity}</span></dd>
                
                  <dt class="required"><g:message code="sgr.property.currentSchoolCountry.label" /> * : </dt><dd id="currentSchool.currentSchoolCountry" class="action-editField validate-capdematEnum required-true i18n-sgr.property.currentSchoolCountry javatype-fr.cg95.cvq.business.users.CountryType" ><g:capdematEnumToField var="${rqt.currentSchool?.currentSchoolCountry}" i18nKeyPrefix="sgr.property.currentSchoolCountry" /></dd>
              ...
              <dl class="required">
                  ...
                  <dt class="required"><g:message code="sgr.property.alevelsDate.label" /> * : </dt><dd id="alevelsInformations.alevelsDate" class="action-editField validate-regex required-true i18n-sgr.property.alevelsDate maxLength-4" regex="^\d{2,4}$"><span>${rqt.alevelsInformations?.alevelsDate}</span></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.alevels.label" /> * : </dt><dd id="alevelsInformations.alevels" class="action-editField validate-capdematEnum required-true i18n-sgr.property.alevels javatype-fr.cg95.cvq.business.request.school.ALevelsType" ><g:capdematEnumToField var="${rqt.alevelsInformations?.alevels}" i18nKeyPrefix="sgr.property.alevels" /></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="">
                  ...
                  <dt class="required condition-isInOtherStudies-trigger"><g:message code="sgr.property.currentStudiesDiploma.label" /> * : </dt><dd id="currentStudiesInformations.currentStudiesDiploma" class="action-editField validate-capdematEnum required-true i18n-sgr.property.currentStudiesDiploma javatype-fr.cg95.cvq.business.request.school.CurrentStudiesType" ><g:capdematEnumToField var="${rqt.currentStudiesInformations?.currentStudiesDiploma}" i18nKeyPrefix="sgr.property.currentStudiesDiploma" /></dd>
                  ...
                  <dt class="required condition-isInOtherStudies-filled"><g:message code="sgr.property.otherStudiesLabel.label" /> * : </dt><dd id="currentStudiesInformations.otherStudiesLabel" class="action-editField validate-string required-true i18n-sgr.property.otherStudiesLabel" ><span>${rqt.currentStudiesInformations?.otherStudiesLabel}</span></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.currentStudiesLevel.label" /> * : </dt><dd id="currentStudiesInformations.currentStudiesLevel" class="action-editField validate-capdematEnum required-true i18n-sgr.property.currentStudiesLevel javatype-fr.cg95.cvq.business.request.school.CurrentStudiesLevelType" ><g:capdematEnumToField var="${rqt.currentStudiesInformations?.currentStudiesLevel}" i18nKeyPrefix="sgr.property.currentStudiesLevel" /></dd>
                  ...
                  <dt class="required"><g:message code="sgr.property.sandwichCourses.label" /> * : </dt><dd id="currentStudiesInformations.sandwichCourses" class="action-editField validate-boolean required-true i18n-sgr.property.sandwichCourses" ><span class="value-${rqt.currentStudiesInformations?.sandwichCourses}"><g:message code="message.${rqt.currentStudiesInformations?.sandwichCourses ? 'yes' : 'no'}" /></span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-trigger"><g:message code="sgr.property.abroadInternship.label" /> * : </dt><dd id="currentStudiesInformations.abroadInternship" class="action-editField validate-boolean required-true i18n-sgr.property.abroadInternship" ><span class="value-${rqt.currentStudiesInformations?.abroadInternship}"><g:message code="message.${rqt.currentStudiesInformations?.abroadInternship ? 'yes' : 'no'}" /></span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipStartDate.label" /> * : </dt><dd id="currentStudiesInformations.abroadInternshipStartDate" class="action-editField validate-date required-true i18n-sgr.property.abroadInternshipStartDate" ><span><g:formatDate formatName="format.date" date="${rqt.currentStudiesInformations?.abroadInternshipStartDate}"/></span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipEndDate.label" /> * : </dt><dd id="currentStudiesInformations.abroadInternshipEndDate" class="action-editField validate-date required-true i18n-sgr.property.abroadInternshipEndDate" ><span><g:formatDate formatName="format.date" date="${rqt.currentStudiesInformations?.abroadInternshipEndDate}"/></span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipSchoolName.label" /> * : </dt><dd id="currentStudiesInformations.abroadInternshipSchoolName" class="action-editField validate-string required-true i18n-sgr.property.abroadInternshipSchoolName" ><span>${rqt.currentStudiesInformations?.abroadInternshipSchoolName}</span></dd>
                  ...
                  <dt class="required condition-makesAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipSchoolCountry.label" /> * : </dt><dd id="currentStudiesInformations.abroadInternshipSchoolCountry" class="action-editField validate-capdematEnum required-true i18n-sgr.property.abroadInternshipSchoolCountry javatype-fr.cg95.cvq.business.users.CountryType" ><g:capdematEnumToField var="${rqt.currentStudiesInformations?.abroadInternshipSchoolCountry}" i18nKeyPrefix="sgr.property.abroadInternshipSchoolCountry" /></dd>
