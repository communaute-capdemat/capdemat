  ...
  <form method="post" id="requestForm" class="advanced-search" action="${createLink(action:'search')}">
    ...
    <div class="yui-g">
      <div class="yui-u first">
        ...
        <input type="text" name="subjectLastName" size="40" value="${params?.subjectLastName}" autofocus/>
        ...
        <a><img id="creationDateFromShow" src="${resource(dir:'css/backoffice/yui/calendar', file:'calendar.gif')}"/></a>
        ...
        <a><img id="creationDateToShow" src="${resource(dir:'css/backoffice/yui/calendar', file:'calendar.gif')}"/></a>
