  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="myr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="myr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="myr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'myr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'autoriteParentale' ? 'current ' : ''}
          
            ${rqt.stepStates['autoriteParentale'].state}
          
          ">
          <span class="number">2</span>
          <a
            <g:if test="${currentStep != 'autoriteParentale' && rqt.stepStates['autoriteParentale'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'autoriteParentale'])}"
            </g:if>
          >
            
              <g:message code="myr.step.autoriteParentale.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['autoriteParentale'].state}" />
        ...
        <li class="${currentStep == 'organismePrestationFamiliale' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.organismePrestationFamiliale.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'situationFamiliale' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.situationFamiliale.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'situationProfessionnelle' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.situationProfessionnelle.label" />
              <span class="help">
        ...
        <li class="${currentStep == 'autreSituation' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.autreSituation.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'projetDeVie' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.projetDeVie.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'allocationEducationEnfantHandicape' ? 'current ' : ''}
          
            ${rqt.stepStates['allocationEducationEnfantHandicape'].state}
          
          ">
          <span class="number">8</span>
          <a
            <g:if test="${currentStep != 'allocationEducationEnfantHandicape' && rqt.stepStates['allocationEducationEnfantHandicape'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'allocationEducationEnfantHandicape'])}"
            </g:if>
          >
            
              <g:message code="myr.step.allocationEducationEnfantHandicape.label" />
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['allocationEducationEnfantHandicape'].state}" />
        ...
        <li class="${currentStep == 'demandeParcoursScolaireEtFormation' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.demandeParcoursScolaireEtFormation.label" />
              <span class="help">
        ...
        <li class="${currentStep == 'demandeCartes' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.demandeCartes.label" />
              <span class="help">
        ...
        <li class="${currentStep == 'demandePrestationCompensation' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="myr.step.demandePrestationCompensation.label" />
              <span class="help">
