    ...
    <h3><g:message code="hcrr.step.enfant.label" /></h3>
      ...
      <dl>
          ...
          <dt><g:message code="hcrr.property.idCentreSejours.label" /></dt><dd>${rqt.centreSejours?.idCentreSejours?.toString()}</dd>

        
          <dt><g:message code="hcrr.property.labelCentreSejours.label" /></dt><dd>${rqt.centreSejours?.labelCentreSejours?.toString()}</dd>
