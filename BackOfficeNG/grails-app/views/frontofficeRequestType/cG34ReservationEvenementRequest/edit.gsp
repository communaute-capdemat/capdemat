...
<html>
  <head>
     <title>${message(code:'crer.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="crer.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="crer.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="crer" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'reservation' ? 'current ' : ''}
            ...
            ${individual ? rqt.stepStates['reservation-' + params.type].state : rqt.stepStates['reservation'].state}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'crer.step.reservation.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
                <g:message code="request.step.message.${rqt.stepStates['reservation' + (individual ? '-' + params.type : '')].state}" />
              </span>
