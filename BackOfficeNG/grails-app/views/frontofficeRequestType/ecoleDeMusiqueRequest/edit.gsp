...
<html>
  <head>
     <title>${message(code:'edmr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="edmr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="edmr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="edmr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'enfant' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'edmr.step.enfant.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'reglements' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="edmr.step.reglements.label" /> *
              <span class="help">
