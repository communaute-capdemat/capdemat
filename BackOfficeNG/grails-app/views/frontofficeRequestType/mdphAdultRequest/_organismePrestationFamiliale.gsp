    ...
    <label for="organismePayeur" class="required"><g:message code="mar.property.organismePayeur.label" /> *  <span><g:message code="mar.property.organismePayeur.help" /></span></label>
            <select id="organismePayeur" name="organismePayeur" class="required  validate-not-first ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('organismePayeur') ? 'validation-failed' : ''}" title="<g:message code="mar.property.organismePayeur.validationError" />">
              <option value=""><g:message code="message.select.defaultOption" /></option>
              <g:each in="${['Caf','Msa','Autre']}">
                <option value="fr.cg95.cvq.business.request.social.OrganismePayeurType_${it}" ${it == rqt.organismePayeur?.toString() ? 'selected="selected"': ''}><g:capdematEnumToText var="${it}" i18nKeyPrefix="mar.property.organismePayeur" /></option>
              </g:each>
            </select>
    ...
    <label class=""><g:message code="mar.property.domiciliationOrganismePayeur.label" />   <span><g:message code="mar.property.domiciliationOrganismePayeur.help" /></span></label>
