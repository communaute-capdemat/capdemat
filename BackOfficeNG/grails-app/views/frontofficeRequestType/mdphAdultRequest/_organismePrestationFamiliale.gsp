    ...
    <label for="numeroAllocataire" class="required"><g:message code="mar.property.numeroAllocataire.label" /> *  <span><g:message code="mar.property.numeroAllocataire.help" /></span></label>
            <input type="text" id="numeroAllocataire" name="numeroAllocataire" value="${rqt.numeroAllocataire?.toString()}" 
                    class="required  validate-string ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('numeroAllocataire') ? 'validation-failed' : ''}" title="<g:message code="mar.property.numeroAllocataire.validationError" />"   />
            

  

  
    <label for="organismePayeur" class="required"><g:message code="mar.property.organismePayeur.label" /> *  <span><g:message code="mar.property.organismePayeur.help" /></span></label>
            <select id="organismePayeur" name="organismePayeur" class="required condition-otherPayingOrganism-trigger  validate-not-first ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('organismePayeur') ? 'validation-failed' : ''}" title="<g:message code="mar.property.organismePayeur.validationError" />">
              <option value=""><g:message code="message.select.defaultOption" /></option>
              <g:each in="${['CAF','MSA','AUTRE']}">
                <option value="${it}" ${it == rqt.organismePayeur?.toString() ? 'selected="selected"': ''}><g:capdematEnumToText var="${it}" i18nKeyPrefix="mar.property.organismePayeur" /></option>
              </g:each>
            </select>
    ...
    <label for="nomAllocataire" class="required"><g:message code="mar.property.nomAllocataire.label" /> *  <span><g:message code="mar.property.nomAllocataire.help" /></span></label>
            <input type="text" id="nomAllocataire" name="nomAllocataire" value="${rqt.nomAllocataire?.toString()}" 
                    class="required  validate-lastName ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('nomAllocataire') ? 'validation-failed' : ''}" title="<g:message code="mar.property.nomAllocataire.validationError" />"  maxlength="38" />
            

  

  
    <label for="prenomAllocataire" class="required"><g:message code="mar.property.prenomAllocataire.label" /> *  <span><g:message code="mar.property.prenomAllocataire.help" /></span></label>
            <input type="text" id="prenomAllocataire" name="prenomAllocataire" value="${rqt.prenomAllocataire?.toString()}" 
                    class="required  validate-firstName ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('prenomAllocataire') ? 'validation-failed' : ''}" title="<g:message code="mar.property.prenomAllocataire.validationError" />"  maxlength="38" />
            

  

  
    <label for="nomOrganismePayeur" class=""><g:message code="mar.property.nomOrganismePayeur.label" />   <span><g:message code="mar.property.nomOrganismePayeur.help" /></span></label>
            <input type="text" id="nomOrganismePayeur" name="nomOrganismePayeur" value="${rqt.nomOrganismePayeur?.toString()}" 
                    class="  validate-string ${rqt.stepStates['organismePrestationFamiliale'].invalidFields.contains('nomOrganismePayeur') ? 'validation-failed' : ''}" title="<g:message code="mar.property.nomOrganismePayeur.validationError" />"   />
            

  

  
    <label class="condition-otherPayingOrganism-filled"><g:message code="mar.property.domiciliationOrganismePayeur.label" />   <span><g:message code="mar.property.domiciliationOrganismePayeur.help" /></span></label>
