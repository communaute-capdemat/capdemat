    ...
    <label for="precisionAutre" class="required condition-estAutreCas-filled"><g:message code="mar.property.precisionAutre.label" /> *  <span><g:message code="mar.property.precisionAutre.help" /></span></label>
            <input type="text" id="precisionAutre" name="precisionAutre" value="${rqt.precisionAutre?.toString()}" 
                    class="required condition-estAutreCas-filled  validate-string ${rqt.stepStates['autreSituation'].invalidFields.contains('precisionAutre') ? 'validation-failed' : ''}" title="<g:message code="mar.property.precisionAutre.validationError" />"   />
            

  

  
    <label for="nomEtablissement" class="required condition-estUnCas-filled"><g:message code="mar.property.nomEtablissement.label" /> *  <span><g:message code="mar.property.nomEtablissement.help" /></span></label>
            <input type="text" id="nomEtablissement" name="nomEtablissement" value="${rqt.nomEtablissement?.toString()}" 
                    class="required condition-estUnCas-filled  validate-string ${rqt.stepStates['autreSituation'].invalidFields.contains('nomEtablissement') ? 'validation-failed' : ''}" title="<g:message code="mar.property.nomEtablissement.validationError" />"   />
            

  

  
    <label class="required condition-estUnCas-filled"><g:message code="mar.property.domiciliationEtablissement.label" /> *  <span><g:message code="mar.property.domiciliationEtablissement.help" /></span></label>
    ...
    <label for="precisionLogementAutre" class="required condition-typeLogement-filled"><g:message code="mar.property.precisionLogementAutre.label" /> *  <span><g:message code="mar.property.precisionLogementAutre.help" /></span></label>
            <input type="text" id="precisionLogementAutre" name="precisionLogementAutre" value="${rqt.precisionLogementAutre?.toString()}" 
                    class="required condition-typeLogement-filled  validate-string ${rqt.stepStates['autreSituation'].invalidFields.contains('precisionLogementAutre') ? 'validation-failed' : ''}" title="<g:message code="mar.property.precisionLogementAutre.validationError" />"   />
