...
<html>
  <head>
     <title>${message(code:'cscr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="cscr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="cscr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="cscr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'acte' ? 'current ' : ''}
          
            ${individual ? rqt.stepStates['acte-' + params.type].state : rqt.stepStates['acte'].state}
          
          ">
          <span class="number">1</span>
          <a
            <g:if test="${currentStep != 'acte' && rqt.stepStates['acte'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'acte'])}"
            </g:if>
          >
            
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'cscr.step.acte.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
                <g:message code="request.step.message.${rqt.stepStates['acte' + (individual ? '-' + params.type : '')].state}" />
              </span>
        ...
        <li class="${currentStep == 'informations' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="cscr.step.informations.label" /> *
              <span class="help">
