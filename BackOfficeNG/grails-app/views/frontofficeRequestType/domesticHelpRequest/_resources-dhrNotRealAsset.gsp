  ...
  <h4>
    <span>
      <g:if test="${currentCollectionItem != null}">
        ${message(code:'dhr.property.dhrNotRealAsset.message.editCollectionItem', default:message(code:'request.message.editCollectionItem'))}${collectionIndex + 1}
      </g:if>
      <g:else>
        ${message(code:'dhr.property.dhrNotRealAsset.message.addCollectionItem', default:message(code:'request.message.addCollectionItem'))}
      </g:else>
    </span>
  </h4>
  ...
  <input type="submit" id="collectionSave" name="collectionSave" value="${message(code:'dhr.property.dhrNotRealAsset.action.' + (currentCollectionItem != null ? 'save' : 'add'), default:message(code:'action.' + (currentCollectionItem != null ? 'save' : 'add')))}" />
  <a href="${createLink(controller : 'frontofficeRequest', action : 'edit', params:['id': rqt.id, 'currentStep': 'resources'])}">
    ${message(code:'dhr.property.dhrNotRealAsset.action.backToMainForm', default:message(code:'request.action.backToMainForm'))}
  </a>
