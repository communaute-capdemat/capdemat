...
<html>
  <head>
     <title>${message(code:'ccrr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="ccrr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="ccrr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="ccrr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'ccrr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
