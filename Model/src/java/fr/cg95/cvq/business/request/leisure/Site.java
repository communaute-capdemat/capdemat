...
public class Site implements Serializable {
    ...
    public final String modelToXmlString() {
        SiteType object = (SiteType) this.modelToXml();
    ...
    public final SiteType modelToXml() {
        
        Calendar calendar = Calendar.getInstance();
        Date date = null;
        LocalTime localTime = new LocalTime();
        SiteType site = SiteType.Factory.newInstance();
        int i = 0;
    
        site.setIdSite(this.idSite);
      
        site.setLabelSite(this.labelSite);
      
        return site;
    }

    public static Site xmlToModel(SiteType siteDoc) {
        Calendar calendar = Calendar.getInstance();
        LocalTime localTime = new LocalTime();
        List list = new ArrayList();
        Site site = new Site();
    
        site.setIdSite(siteDoc.getIdSite());
      
        site.setLabelSite(siteDoc.getLabelSite());
